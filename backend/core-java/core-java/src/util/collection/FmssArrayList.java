...
public class FmssArrayList<E> implements List<E> {
    ...
    public FmssArrayList()
    {
        m_elems = (E[])new Object[DEFAULT_CAPACITY];
    }

    @SuppressWarnings("unchecked")
    public FmssArrayList(int initialCapacity)
    {
        checkCapacity(initialCapacity);
        m_elems = (E [])new Object[initialCapacity];
    }

    public FmssArrayList(Collection<? extends E> collection)
    {
        this();
        addAll(collection);
    }
